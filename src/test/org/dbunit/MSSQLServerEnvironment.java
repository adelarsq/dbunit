/*
 * MSSQLEnvironment.java   Feb 18, 2002
 *
...
public class MSSQLServerEnvironment extends DatabaseEnvironment
{
    public MSSQLServerEnvironment(DatabaseProfile profile) throws Exception
    {
        super(profile);

        // Creates required tables into the mssql database
/*
        BufferedReader sqlReader = new BufferedReader(
                new FileReader(new File("src/sql/mssql.sql")));
